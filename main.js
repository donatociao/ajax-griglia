 ...
 $(document).ready(function() {
  ...
  $.ajax({
    ...
    success: function(data) {
      ...
      console.log('il response API è' + data.response);
      ...
      //imposto istruzioni di compilazione
      var quadrato;
      if (random <= 5) {
  ...
  //compilo template con handlebars


});


// //popolo il contenitore con i quadrati da cliccare
// var i = 0;
// while (i = 35) {
//   $('.game').append($('.square').clone());
//   i++;
//  }
